...
local Session = require('pasta.kit.Thread.Server.Session')
...
---@class pasta.kit.Thread.Server
---@field private dispatcher fun(session: pasta.kit.Thread.Server.Session): nil
---@field private session? pasta.kit.Thread.Server.Session
...
---@param dispatcher fun(session: pasta.kit.Thread.Server.Session): nil
---@return pasta.kit.Thread.Server
...
function Server:connect()
  return Async.run(function()
    ...
    vim.api.nvim_create_autocmd({ 'VimLeave' }, {
      desc = 'pasta.kit.Thread.Server:on_exit',
      once = true,
      callback = function()
        self:kill()
      end
