...
local Session = require('pasta.kit.Async.RPC.Session')

---@class pasta.kit.Async.RPC.Thread
---@field private thread uv.luv_thread_t
---@field private session pasta.kit.Async.RPC.Session
local Thread = {}
Thread.__index = Thread

---Create new thread.
---@param dispatcher_ fun(session: pasta.kit.Async.RPC.Session)
