...
---@class pasta.kit.Async.WorkerOption
---@field public runtimepath string[]

---@class pasta.kit.Async.Worker
local Worker = {}
  ...
  return AsyncTask.new(function(resolve, reject)
    uv.new_work(function(runner, args, option)
      ...
      local ok, res = pcall(function()
        return require('pasta.kit.Async.AsyncTask').resolve(assert(loadstring(runner))(unpack(args))):sync()
      end)
